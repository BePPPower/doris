...
public class OutFileClause {
    ...
    public OutFileClause(String filePath, String format, Map<String, String> properties) {
        ...
        if (Strings.isNullOrEmpty(format)) {
            fileFormatProperties = FileFormatProperties.createFileFormatChecker("csv");
        } else {
            fileFormatProperties = FileFormatProperties.createFileFormatChecker(format.toLowerCase());
        }
    }
